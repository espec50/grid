...
def find_horizonstal_harness_dist(someGridNum):
    if alley == 1:
        option1 = abs(int(someGridNum - cable_tray5))*2
        option2 = abs(int(someGridNum - cable_tray6))*2
    elif alley == 2:
        option1 = abs(int(someGridNum - cable_tray3))*2
        option2 = abs(int(someGridNum - cable_tray4))*2
    elif alley == 3:
        option1 = abs(int(someGridNum - cable_tray1))*2
        option2 = abs(int(someGridNum - cable_tray2))*2
    return option1,option2

#Call function to find the two distance options from cabinet grid to left and right outer rail paths
cab_to_your_tray1 = find_horizonstal_harness_dist(int(userGridNum))[0]
...
frr1_to_your_tray1 = find_horizonstal_harness_dist(int(your_FrrPair_1_num))[0]
frr1_to_your_tray2 = find_horizonstal_harness_dist(int(your_FrrPair_1_num))[1]
...
final_to_frr1_option1 = frr_vertical_dist2 + cab_to_your_tray1 + frr2_to_your_tray1
final_to_frr1_option2 = frr_vertical_dist2 + cab_to_your_tray2 + frr2_to_your_tray2
...
print(f'Total distance to FRR1 option 1: {final_to_frr1_option1} via cable tray {tray_num1}')
print(f'Total distance to FRR1 option 2: {final_to_frr1_option2} via cable tray {tray_num2}')

print("Values:")
print(f'frr vertical dist {frr_vertical_dist2}')
print(f'cab to your tray1:{cab_to_your_tray1}')
print(f'cab to your tray2:{cab_to_your_tray2}')
print(f'cab to your tray1:{frr2_to_your_tray1}')
print(f'cab to your tray2:{frr2_to_your_tray2}')
